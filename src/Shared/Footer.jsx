      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-gray-700 pb-8">
          ...
          <div className="text-center md:text-left">
            <img src={logo} alt="Logo" className="mx-auto md:mx-0 w-32 mb-4" />
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm text-gray-400 mt-6 text-center">
          ...
          <a href="#" className="hover:text-white transition-colors">Delivery Policy</a>
          <a href="#" className="hover:text-white transition-colors">Warranty</a>
          <a href="#" className="hover:text-white transition-colors">Privacy Policy</a>
          <a href="#" className="hover:text-white transition-colors">Return and Refund Policy</a>
          <a href="#" className="hover:text-white transition-colors">Terms and Conditions</a>
        </div>

        {/* Copyright */}
        <div className="text-center text-gray-500 text-sm mt-6">
          © 2025 website name. All rights reserved.
        </div>
      </div>
    </footer>
  );
